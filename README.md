...
### L'animation est très diversifié et se retrouve dans plusieurs domaines du multimédia comme pour faire de la vidéo ou bien dans des projections lumineuses, et bien d'autres encore.
### Elle peut être utilisé pour créer des effet, aider à l'acquisition des connaissances, faire des concepts pour des projets, etc.
### Il est très facile de faire de l'animation et nous pouvons facilement trouver différents logiciels qui sont gratuits pour nous aider.
